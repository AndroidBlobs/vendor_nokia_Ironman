...
#imx499_mipi_raw s5k2t7sp_mipi_raw s5k3l8_mipi_raw s5k5e8yx_mipi_raw ov8856_mipi_raw imx318_mipi_raw imx386_mipi_raw
CUSTOM_HAL_LENS = cn3927e
#lc898212xdaf bu6424af ak7371af dummy_lens
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ironman_lianyi_gc5035_mipi_raw ironman_qunhui_gc5035_mipi_raw
#s5k2t7sp_mipi_raw
...
CUSTOM_MODEM=TK_MD_BASIC_LWTG_6177M_R3_6761_T99621AA1
...
MTK_AWS_SUPPORT = no
##+req IRM-179 Should be able to connect Xcal,yuanmiao,20190717,
...
#+Extb IRM-128,sizhikai.wt,Clear codes 33/29 for Data,20190727.
...
#+ Bug326207, yangpingao@WT, add charger driver(bq24157), 20190705
MTK_DUAL_CHARGER_SUPPORT = no
#- Bug326207, yangpingao@WT, add charger driver(bq24157), 20190705
MTK_DUAL_DISPLAY_SUPPORT = 0
MTK_DUAL_MIC_SUPPORT = no
#Chk32376 liujun5.wt modify 20190821 close dual mic setting
...
#Extb IRM-1341,wangzheng2.wt,mod,20190807,In the SMS settings, when the wireless emergency alert is clicked, the cell broadcast has stopped running.
...
#+Extb IRM-1890,cjd.wt,no wma lisence,delete wma codec, 20190913.
...
#####-------WINGTECH--------#####
WT_INNER_VERSION=SW_T99621AA1_V058_M11_NF_NOKIA_Ironman_USR_MP
WT_HARDWARE_VERSION = XXX
WT_CUSTOMER_NAME = XXX
WT_PRODUCT_PROJECT = T99621AA1
USE_SENSOR_MULTI_HAL=true
#ExtB IRM-534, shanbopeng.wt, RTT, 20190709
 MTK_RTT_SUPPORT=yes

#Req chenhaibing.wt, add software version
WT_PRODUCTION_ORI=V1.240_B01
WT_PRODUCTION_VERSION=V1.240_B01
